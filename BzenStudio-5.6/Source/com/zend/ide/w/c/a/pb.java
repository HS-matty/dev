...
public class pb extends ab
{
  ...
  private void f()
  {
    ...
    this.g = new x(ct.a(5));
    this.g.addItemListener(new db(this));
    this.r = new w(ct.a(116));
    this.r.addActionListener(new eb(this));
    this.s = new w(ct.a(117));
    this.s.addActionListener(new fb(this));
    this.n.add(this.r);
    this.n.add(this.s);
  ...
  static void a(pb parampb, int paramInt)
  {
    parampb.a(paramInt);
  }

  static void b(pb parampb, int paramInt)
  {
    parampb.a(paramInt);
  }
}
 ...
 * Qualified Name:     com.zend.ide.w.c.a.pb
