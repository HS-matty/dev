...
public class cy extends ih
{
  private bk b;
  private transient Segment c = new Segment();
  private transient Segment d = new Segment();
    ...
    throws BadLocationException
  {
    ...
    int i6 = paramInt3 - i2;
    ((Document)localObject1).getText(i2, i4, this.c);
    ...
    if (this.b == null)
      a();
    this.b.a(this.c);
    this.b.a(localObject3);
    int i7 = this.b.a(i6);
    int i9 = this.b.f() + i6;
    while ((i5 > 0) && (i7 != -1))
    {
      int i8 = this.b.e() - i9;
      this.b.a(i9, Math.min(i8, i5), this.d);
      ...
      {
        i12 = Utilities.getTabbedTextWidth(this.d, paramGraphics.getFontMetrics(), paramInt1, this, paramInt3);
        if (i11 != 0)
        {
      ...
      {
        paramInt1 = Utilities.drawTabbedText(this.d, paramInt1, paramInt2, paramGraphics, this, paramInt3);
      }
      paramInt3 += i8;
      i9 += i8;
  ...
  {
    this.d.count = Math.min(paramInt4, paramInt5);
    int i = Utilities.drawTabbedText(this.d, paramInt1, paramInt2, paramGraphics, this, paramInt3);
    this.d.offset += this.d.count;
    return i;
  }

  private int a(int paramInt1, int paramInt2, Graphics paramGraphics, int paramInt3, int paramInt4)
  {
    this.d.count = paramInt4;
    int i = Utilities.drawTabbedText(this.d, paramInt1, paramInt2, paramGraphics, this, paramInt3);
    this.d.offset += this.d.count;
    return i;
  }
  ...
  public void a()
  {
    this.b = kc.b((ho)getDocument());
  }
}

/* Location:           C:\Program Files\Zend\ZendStudio-5.5.1\bin\ZendIDE.jar
 * Qualified Name:     com.zend.ide.s.cy
